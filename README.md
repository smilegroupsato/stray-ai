...
Visit Report v0 Phase 1 and Phase 2 are complete. Phase 2.1 adds trusted repository coordinates, exact commit-fixed page links, and a relative return link from every individual Report to `index.html`. It remains independent of the HTTP server and contains no controls.
