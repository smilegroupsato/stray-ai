...
Notice local laws, pressures, contradictions, recurring gravity, forgotten documents, stale links, and functions that appear unwell.
...
Do not create a task list. If something seems broken, record it as an observed smell or residue, not as an instruction.
